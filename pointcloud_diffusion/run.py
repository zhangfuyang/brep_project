...
parser.add_argument('--config', type=str, default='pointcloud_diffusion/configs/train_point_partial_v2.yaml')
...
elif config['data_params']['class_type'] == 'PartialPCLatentDataset':
    DataClass = PartialPCLatentDataset
