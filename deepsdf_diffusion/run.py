...
from diffusion_model import JointModel
...
face_model = load_model(SDFModel, 
                        config['exp_params']['face_model']['config'], 
                        config['exp_params']['face_model']['pretrained_path'],
                        exclude_prefix='model.', remove_keys=('latent_code.weight',))
sdf_model = load_model(SDFModel, 
                        config['exp_params']['solid_model']['config'], 
                        config['exp_params']['solid_model']['pretrained_path'],
                        exclude_prefix='model.', remove_keys=('latent_code.weight',))
model = JointModel(config['model_params'])
...
DataClass = SDFDataset
train_dataset = DataClass(config['data_params']['train'])
...
val_dataset = DataClass(config['data_params']['train'])
