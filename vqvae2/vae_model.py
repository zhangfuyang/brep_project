...
class VQVAE3D(nn.Module):
    def __init__(self, n_channels, with_conv=True, num_res_blocks=2, ch=64,
        ...
        self.fc_mu = Mid(in_channels[-1]*_ch, self.codebook_dim, num_res_blocks=self.num_res_blocks)
        self.fc_logvar = Mid(in_channels[-1]*_ch, self.codebook_dim, num_res_blocks=self.num_res_blocks)
    ...
    def forward(self, x, vq_weight):
        ...
        return self.decode(quantized_inputs), vq_loss, mu, logvar
