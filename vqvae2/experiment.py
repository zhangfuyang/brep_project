...
class VAEExperiment(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_dict = self.vae_model.loss_function(
            recon, batch, vq_loss, mu, logvar, **self.config)
        loss = loss_dict['loss']
        ...
        self.log('kl_loss', kl_loss, rank_zero_only=True, prog_bar=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        loss_dict = self.vae_model.loss_function(recon, batch, vq_loss, mu, logvar, **self.config)
        loss = loss_dict['loss']
