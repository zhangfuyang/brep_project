...
class Solid3DModel_v2(nn.Module):
    def __init__(self, config):
        ...
        self.face_model = UNet3DModel(in_channels+1, out_channels, freq_shift, 
    ...
    def forward(self, faces, solid, face_cond_mask, timestep):
        solid = solid[:,0]
        # solid: bs, ch, n, n, n
        # faces: bs, m, ch, n, n, n
        # face_cond_mask: bs, m, 1, n, n, n
        ...
        face_latent = self.face_model.conv_in_model(torch.cat((faces, face_cond_mask), 2)) # bs, m, ch, n, n, n
